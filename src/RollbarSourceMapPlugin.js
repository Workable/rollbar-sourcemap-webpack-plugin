...
class RollbarSourceMapPlugin {
  ...
  handleError(sourceMap, err, statusCode, body) {
    ...
    try {
      ...
      const parseError = new Error(e, `failed to parse ${body}`);
      return new VError(parseError, errMessage);
    }
  }
}
