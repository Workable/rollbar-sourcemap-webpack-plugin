...
var RollbarSourceMapPlugin = function () {
  ...
  (0, _createClass3.default)(RollbarSourceMapPlugin, [{
    ...
    value: function uploadSourceMap(compilation, _ref2, cb) {
      ...
      var minifiedFileUrl = '' + this.publicPath + sourceFile;
      ...
      _async2.default.retry({ times: this.retries, interval: 100 }, function (callback) {
        ...
        if (statusCode !== 200) {
          cb(this.handleError(sourceMap, err, statusCode, body));
          return;
        }
    ...
    key: 'handleError',
    value: function handleError(sourceMap, err, statusCode, body) {
      var errMessage = 'failed to upload ' + sourceMap + ' to Rollbar with status code ' + statusCode;

      if (err && err.message) {
        return new _verror2.default(err, errMessage);
      }
